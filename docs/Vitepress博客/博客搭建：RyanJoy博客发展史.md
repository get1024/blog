---
title: 博客搭建：RyanJoy博客发展史
createAt: 2025-10-28 07:43:17
updateAt: 2026-02-11 05:42:42
tags:
  - 博客
---
...
你说看到的大部分 `docs/` 本来都是基于 [Obsidian](https://obsidian.md/) 的个人知识库，但后来发现「移动浏览」十分不便，就萌生出实现「多端同步」的想法。
...
权衡利弊之下，我开始寻找基于 [Markdown](https://markdown.com.cn/basic-syntax/) 的静态页面部署方案，这一点我在 [博客搭建：个人博客搭建、使用最佳解决方案](博客搭建：个人博客搭建、使用最佳解决方案.md#ssg选择) 一文中也提及过，有选型困难的朋友也可以前去参考。在最开始，我尝试了 [MkDocs](https://www.mkdocs.org/) ，后来发现页面布局和样式不符合期待，索性迁移至 [VitePress](https://vitepress.dev/zh/)，这便有了本版博客。
